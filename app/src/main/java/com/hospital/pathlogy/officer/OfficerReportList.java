...
import com.hospital.pathlogy.report.ReportDetailFragment;
 ...
 */
public class OfficerReportList extends Fragment {
    ...
    private void getData() {
        ...
        //CHnage method TO POST when sending actual request
        StringRequest jsonArrayRequest = new StringRequest(Request.Method.GET,"https://api.myjson.com/bins/ji6qs" /*Config.SERVER_URL+"/getReports"/*/,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("doctorName", username);
