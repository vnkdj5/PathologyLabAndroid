...
import com.hospital.pathlogy.AboutUsFragment;
import com.hospital.pathlogy.Config;
import com.hospital.pathlogy.LoginActivity;
import com.hospital.pathlogy.MainActivity;
...
public class OfficerMainActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        TextView textViewUsername = findViewById(R.id.tvOfficerName);
        TextView textViewDetails =  findViewById(R.id.tvOfficerDetail);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Ohome) {
            fragment=new OfficerHomeFragment();
        } else if (id == R.id.nav_Oreports) {

        } else if (id == R.id.nav_Oclinic) {
            fragment=new AboutUsFragment();

        } else if (id == R.id.nav_Oshare) {
